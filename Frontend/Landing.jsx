...
const Hero = () => {
  return (
    <section className=" from-white to-gray-100 relative overflow-hidden bg-[radial-gradient(circle,_rgba(209,213,219,0.4)_1px,_transparent_1px)] [background-size:16px_16px]">
...
const Partners = () => {
  const partnerLogos = [
    {
      src: 'Frontend/assets/partners/microsoft-for-startups.png',
      alt: 'Microsoft for Startups'
    },
    {
      src: 'Frontend/assets/partners/zero-one.png',
      alt: 'Zero One'
    },
    {
      src: 'Frontend/assets/partners/Dossie Technologies.png',
  ...
  return (
    <section className="bg-white py-16 lg:py-12 bg-[radial-gradient(circle,_rgba(209,213,219,0.4)_1px,_transparent_1px)] [background-size:16px_16px]">
